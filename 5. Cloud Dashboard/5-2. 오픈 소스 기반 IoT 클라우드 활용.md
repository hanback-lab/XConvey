...
차트의 종류 중 "Time series chart" 를 활용해 보겠습니다. Datasource 는 등록되어 있는 장치중 어떠한 장치를 통해 데이터를 수신하여 위젯에 출력할 것인지 선택하며 Series의 Key는 장치에서 데이터를 송신 시 사용됩니다. 
...
#### Button Appearance Setting(Checked)
![dashboard11](res/dashboard11.png)

#### Button Appearance Setting(Unchecked)
...
## XConvey 연동 
XConvey의 TPHG 센서의 데이터 중 온도와 습도, 그리고 5개의 램프를 제어하는 대시보드를 구성합니다. 각 위젯의 설정은 다음과 같습니다. 
